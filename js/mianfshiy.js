...
//	上面的点击事件
    $(".sc2>span").click(function(){
    	$(this).children().css("width","100%").parent('span').siblings().children().css("width","0%")
    })
    $(".sc11>span").click(function(){
    	$(this).children().css("width","100%").parent('span').siblings().children().css("width","0%")
    })
    $(".sc11>.dazhong").click(function(){
    	$(".sc2").show();
    	$(".yinzz").hide();
    })
    $(".sc11>.ty").click(function(){
    	$(".sc2").hide();
    	$(".yinzz").show();
    })
    $(".sc2>.zuixn").click(function(){
    	$(".sc8>.e").hide();
    	$(".sc8>.s").hide();
    	$(".sc8>.si").hide();
    	$(".sc8>.y").show();
    })
     $(".sc2>.zuire").click(function(){
    	$(".sc8>.y").hide();
    	$(".sc8>.s").hide();
    	$(".sc8>.e").show();
    	$(".sc8>.si").hide();
    })
     $(".sc2>.pinlei").click(function(){
    	$(".sc8>.y").hide();
    	$(".sc8>.e").hide();
    	$(".sc8>.s").show();
    	$(".sc8>.si").hide();
    })
      $(".sc2>.js").click(function(){
    	$(".sc8>.y").hide();
    	$(".sc8>.e").hide();
    	$(".sc8>.s").hide();
    	$(".sc8>.si").show();
